...
export const Volume04ClassName = "route__volume-04";
 ...
 *
 */
const Volume04: NextPage<LMNTS_Volume04> = () => {
  return (
    <div className={`${Volume04ClassName}`}>
      <VolumesArrowsNavigation />
      <HorizontalScrollSection hasTopbar={true}>
        <HeroColumn 
          header="Free Thoughts"
